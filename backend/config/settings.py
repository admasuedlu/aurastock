...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="aurastock"),
        "USER": config("DB_USER", default="aurastock"),
        "PASSWORD": config("DB_PASSWORD", default="aurastock"),
        "HOST": config("DB_HOST", default="localhost"),
        "PORT": config("DB_PORT", default="5432"),
    }
}

LOCAL_DEV_MODE = config("USE_SQLITE", default=False, cast=bool)
